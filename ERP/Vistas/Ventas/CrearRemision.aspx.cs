...
namespace ERP.Vistas.Ventas
{
    public partial class CrearRemision : System.Web.UI.Page
    {
        ...
        protected void GenerarFolio_Click(object sender, EventArgs e)
        {
            ...
            lblFolio.Text = $"Folio: {(String)ViewState["FolioRemision"]}";
        }
        ...
        protected void BtnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            peticion.PedirComunicacion($"Remisiones/ComprobarFolio/{ViewState["FolioRemision"]}", MetodoHTTP.GET, TipoContenido.JSON, (String)Session["jwt"]);
