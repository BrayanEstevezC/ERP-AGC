...
namespace ERP.Controllers
{
    public class UsuariosController : ApiController
    {
        ...
        public PeticionEstado ActualizarUsuario(clsUsuario usuario)
        {
            ...
            var UsuarioExistente = bd.Usuario.FirstOrDefault(c => c.ID == usuario.ID);
            var PerfilExistente = bd.Perfil.FirstOrDefault(c=> c.ID == usuario.PerfilID);
            try
            {
                if (!accesoPerfil.ComprobarAcceso(usuarioJwt.uap) || !NombrePerfil.Equals("Super Admin"))
                {
                ...
                if(UsuarioExistente.perfil.Nombre.Equals("Super Admin") && UsuarioExistente.perfil.Nombre != PerfilExistente.Nombre)
                {
