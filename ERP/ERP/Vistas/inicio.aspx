                ...
                <article class="row justify-content-around  p-2 gap-1 pb-2">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 cards mb-3" id="ventas">
                        <div class="card bg-dark border-Green">
                            <asp:Image runat="server" ImageUrl="~/Media/Resources/Cotizaciones.jpg" alt="Ventas" class="card-img-top align-self-center" />
                    ...
                    <div class="col-12 col-md-6 col-lg-3 cards mb-3" id="catalogos">
                        <div class="card bg-dark border-Green">
                            <asp:Image runat="server" ImageUrl="~/Media/Resources/Productos.jpg" alt="Catalogos" class="card-img-top align-self-center imgCard" />
                            <div class="card-body bg-dark">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 cards mb-3" id="compras">
                        <div class="card bg-dark border-Green">
                            <asp:Image runat="server" ImageUrl="~/Media/Resources/OrdenVenta.jpg" alt="Compras" class="card-img-top align-self-center imgCard" />
                            <div class="card-body bg-dark">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 cards mb-3" id="sistema">
                        <div class="card bg-dark border-Green">
                            <asp:Image runat="server" ImageUrl="~/Media/Resources/Usuarios.jpg" alt="Compras" class="card-img-top align-self-center imgCard" />
                            <div class="card-body bg-dark">
